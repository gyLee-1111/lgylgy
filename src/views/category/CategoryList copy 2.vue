                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="keyword_type_select">
                                            ...
                                            <input type="radio" name="keyword_type" id="keyword_type_shopping" value="쇼핑성" v-model="keywordType">
                                            <label for="keyword_type_shopping">쇼핑성</label>

                                            <input type="radio" name="keyword_type" id="keyword_type_infomation" value="정보성" v-model="keywordType">
            ...
            <div class="content_box_white">
                ...
                <div class="content_header">
                    ...
                    <div class="left">
                        ...
                        <div class="view_check">
                            <input type="checkbox" id="checkOnly" v-model="checkSelectOnly" @change="toggleCheckSelect('checkSelect')" />
                                ...
                                <table id="table_keyword_searchresult" class="table_keyword_searchresult">
                                    ...
                                    <tbody>
                                        <tr v-for="keyword  in filteredRes" :key="keyword.keywordCode">
                                            <td class="label_keep"><i :class="['fa-heart', 'keep', keyword.checkSelect === 'Y' ? 'fa-solid keep_on' : 'fa-regular']" @click.stop="checkFavorite(keyword)"></i></td>
                                            ...
                                            <td @click="detailKeyword(keyword.keywordCode)">{{ keyword.keywordType }}</td>
...
export default {
    ...
    const searchMin = ref(0)
    const searchMax = ref(0)
    const searchPcMin = ref(0)
    const searchPcMax = ref(0)
    const searchMobileMin = ref(0)
    const searchMobileMax = ref(0)
    ...
    const getTopCategory = async() =>{
        try{
            const response = await axios.get('http://localhost:8084/public/getTopCategory'
        //     ,
        // {
        //   headers: {
    ...
    const getSubCategory = async() =>{
        try{
            const response = await axios.get('http://localhost:8084/public/getSubCategory',{
                params:{
    ...
    const getListKeyword = async() =>{
        ...
        try{
            const response = await api.post('http://localhost:8084/public/getListKeyword', params,
            {headers: {
...
*/
    ...
    const downloadExcel = async () => {
        try {
            ...
            const response = await api.get('http://localhost:8084/reviewPop/downloadExcel', {
                params: {
